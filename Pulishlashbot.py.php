...
ob_start();
define("uzfox","1886489039:AAEpswXM-t-6ZZ57lKhxbq1jJRrxVx5QDQM");
$admin = "753363624";
$botname = "💵Pul Ishlaydigan Bot✅";
...
"inline_keyboard"=>[
[["text"=>"➕ A‘zo bo‘lish","url"=>"https://t.me/joinchat/JlESIjKLnKJiN2Q6"],],
[["text"=>"➕ A‘zo bo‘lish","url"=>"http://t.me/Samo_vines_kanal"],],
[["text"=>"➕ A‘zo bo‘lish","url"=>"https://t.me/joinchat/Ybo-kAPjG7Y4NWVi"],],
...
"parse_mode"=>"markdown",
       ...
       uzfox("sendMessage",[
              ...
              "parse_mode"=>"html",
               "reply_markup"=>json_encode([   
   "inline_keyboard"=>[
[["text"=>"👨‍💻 Admin","url"=>"https://telegram.me/Sarvarboy2021"],["text"=>"👥 Kanalimiz","url"=>"https://t.me/https://t.me/pullarishlakanal"],],
]
]),
]);
}

if((stripos($callbackdata,"no|")!==false) and ($from_id=="753363624")){
        uzfox("deleteMessage",[
    "chat_id"=>$chat_id,
    "message_id"=>$message_id,
]); 
...
if((stripos($callbackdata,"ban|")!==false) and ($from_id=="753363624")){
        uzfox("deleteMessage",[
    "chat_id"=>$chat_id,
    "message_id"=>$message_id,
]); 
...
uzfox("sendMessage",[
   "chat_id"=>$chatid,
   "text"=>"Nima haqida yozmoqchisiz? 😊\n\n<b>📞 Aloqa markazi:</b> @Sarvarboy2021",
"parse_mode"=>"html",
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"🗣 Bog'lanish","url"=>"https://t.me/Sarvarboy2021"],],
]
]),
]);
}
